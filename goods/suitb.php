...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/goods/suitb.css"/>
    ...
    <body>
        ...
        <div class="wrap">
            <div id="contentsBanner">
                <h2 class="visuallyhidden">贴心呵护  由内而外</h2>
            </div>
            ...
            <div id="ContentWrap">
                ...
                <div class="product-list">
                    <img src="../images/goods/suitb_product_list01.jpg">
                </div>
        ...
        <script type="text/javascript">
            $(function(){
                ...
                var maxNum = 3
                var imgUrl = ""
                var imgPrefix = "../images/goods/suitb_product_list0"
